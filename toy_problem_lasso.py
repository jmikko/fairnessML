...
def toy_test_generator(n_samples, n_samples_low, varA, aveApos, aveAneg, varB, aveBpos, aveBneg, lasso_dataset=False, number_of_random_features=1000):
    # TRAIN DATASET
    ...
    return X, y, X_test, y_test, idx_A, idx_B, sensible_feature, sensible_feature_id
...
if __name__ == '__main__':
    ...
    X, y, X_test, y_test, idx_A, idx_B, sensible_feature, sensible_feature_id =\
